...
Currently included
- `maxvis`: Softmax vs [Sparsemax](https://arxiv.org/abs/1602.02068) vs [Entmax](https://arxiv.org/abs/1905.05702) in 3D — adjust a 3D logit vector and see softmax(z), sparsemax(z), entmax(z) on the probability simplex, with the raw z point in 3D.
